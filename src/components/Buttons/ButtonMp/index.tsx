          ...
          content={
            <div className=''>
              ...
              <div className='mx-auto w-full max-w-sm flex items-center justify-center flex-col'>
                ...
                <input onChange={(e) =>{setCredits(e.target.value)}} type="number" placeholder="Valor do credito" className="input text-black input-bordered w-full input-warning   bg-slate-100 my-3" />
                  ...
                  <QrCodeContainer>
                    <div>
                      ...
                      <h3>{new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(payment.valuePix)}</h3>
                      <h3 className='font-bold'>Chave Pix</h3>
                      <div className=" bg-white">
                        <div className="input-group flex items-center">
                          <input type="text" placeholder="Search…" value={payment.keyPix} className="input text-black input-bordered w-full input-warning   bg-slate-100 my-3 input-sm" />
                ...
                <button onClick={buyCredits} className="w-full btn btn-outline btn-warning">Gerar Qr-code</button>
              <div>
            </div>
        </div>
      </div>
