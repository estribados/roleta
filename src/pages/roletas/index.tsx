      ...
      <Container>
        <div className='w-full h-full flex justify-between md:mt-20 mt-5  '>
          <div className='w-full md:w-1/2 border-r-2 px-5'>
            <h1 className='w-full text-center text-2xl  mb-5 '>CADASTRO DE ROLETA</h1>

            <Form className='w-full overflow-y-auto max-h-[500px]' ref={formRef} onSubmit={handleSubmit}>
              <ContainerLabel >
                <Label htmlFor="nome">
